package com.example.demo.A_msb.io.rpcdemo;
...
import com.example.demo.A_msb.io.rpcdemo.proxy.MyProxy;
import com.example.demo.A_msb.io.rpcdemo.rpc.Dispatcher;
import com.example.demo.A_msb.io.rpcdemo.rpc.protocol.MyContent;
import com.example.demo.A_msb.io.rpcdemo.service.*;
import com.example.demo.A_msb.io.rpcdemo.util.SerDerUtil;
...
/**
 * 上节课，基本写了一个能发送 小问题，当并发通过一个连接发送后，服务端解析bytebuf 转 对象的过程出错
 */
        ...
        ChannelFuture bind = sbs.group(boss, worker).channel(NioServerSocketChannel.class)
                .childHandler(new ChannelInitializer < NioSocketChannel >() {
                    ...
                    protected void initChannel(NioSocketChannel ch) throws Exception {
                        ...
                        // 其实netty提供了一套编解码
                        p.addLast(new HttpServerCodec()).addLast(new HttpObjectAggregator(1024 * 512))
